...
OpenAlex is the sole academic source. Results are normalized, deduplicated,
scored, cached, and persisted per task.
"""
...
def build_academic_queries(problem_title: str, question_text: str, user_message: str = "") -> list[str]:
    ...
    The query is intentionally English-heavy because OpenAlex metadata is mainly
    English, while Chinese domain words are retained for local relevance.
    """
